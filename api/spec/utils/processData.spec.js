...
/*
after loads of modification of this testing file.
the previous error says the 'data.daily[i]' in 'undefined' 
it means that the array 'data.daily' is shorter than 3 elements or doesn't exist at all.
However, test passing.
this captures any error thrown when calling 'processData' with invalid inputs and
checks if the error is defined.
